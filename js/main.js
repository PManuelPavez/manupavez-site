// js/main.js (limpio, sin duplicados)
(() => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    initMobileNav();
    initHeaderAndHero(prefersReducedMotion);
    initReveal();
    ...
    initContactForm();
    initMediaSliders();
    initHeroPointerGlow(); // toque “frecuencia”
  });
  ...
  function initHeaderAndHero(reduceMotion) {
